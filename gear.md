---
title: "Sailing Apparel & Gear"
permalink: /apparel/
published: true
last_modified_at: 2018-02-27 16:11:00 -0800
...
It's important to know that sailing [Apr-Oct in Long Beach]({{ page.url-local-climate }}) doesn't really require a lot of specialized gear.  That's because its warmer and doesn't rain often. However, when sailing on bad weather days special gear is required to stay warm. It can also help with improved ease of movement in a boat, some provide better protection, and durability.  In any event, be prepared for the [colder rainy months (starting in Nov/Dec thru Mar/Apr)]({{ page.url-local-climate }}). In these winter months, and also travel regattas to NorCal any time of year, it's important to have gear to keep warm and dry.


<div class="alert alert-warning" markdown="1">
## Required Sailing Gear

1.   **Life jacket** — Must be _US Coast Guard Approved_ Personal Flotation Device (AKA. _USCG Approved PFD_). Be careful not to buy a _buoyancy aid_ or _inflatable life vest_. Neither is acceptable (per ISSA rules). If you're new and unsure of commitment, start with something less expensive. It can always become a backup/practice jacket.
...
1.   **Sunscreen** — UV is stronger on the water due to both reflected and sometimes magnified sunlight. Choose a sunscreen with good UVA protection containing __ecamsule, avobenzone, oxybenzone, titanium dioxide, sulisobenzone, or zinc oxide__. Even [sailors with dark skin tones](http://www.skincancer.org/prevention/skin-cancer-and-skin-of-color) need to wear sunscreen.

1.   **Sunglasses** — _with UV protection_.  A strap/clip is also helpful to ensure they're not lost during a capsize or blown away. Avoid future eye problems and wear sunglasses. UV radiation affects skin & eyes over time.

1.   **Hat** — For UV protection of face and back of the neck. A hat with an attached strap, or a separate clip-on strap. But again, use sunblock. The water reflects UV light even on cloudy days.
...
1.   **Watch** — Waterproof watch with a countdown timer (this is necessary for all racing sailors)
</div>
...
1.  **Base layer:** _Wicks moisture._ A base layer should be specially made to wick moisture away from the skin to help stay warm after a capsize or to cool on a hot day; look for clothing designed for this with fabric made from bamboo viscose, merino wool, and synthetic fibers (polyester, spandex, lycra).
...
-   [West Marine Stores](https://www.google.com/maps/search/west+marine/@33.764632,-118.2280089,13z/data=!3m1!4b1) located here in Long Beach,  There are others nearby, such as San Pedro and Newport Beach.
